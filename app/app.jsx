...
export default class App extends Component {
  ...
  render() {
    ...
    const LoadableSetting = Loadable({
      loader: () => import(/* webpackChunkName: "setting" */ './container/setting'),
      loading: Loading,
    });
    const LoadableForm = Loadable({
      loader: () => import(/* webpackChunkName: "form" */ './container/form'),
      loading: Loading,
    });
    const LoadableDetail = Loadable({
      loader: () => import(/* webpackChunkName: "detail" */ './container/detail'),
      loading: Loading,
    });
    const LoadableCommentDetail = Loadable({
      loader: () => import(/* webpackChunkName: "comment" */ './container/comment'),
      loading: Loading,
    });
    const LoadableTag = Loadable({
      loader: () => import(/* webpackChunkName: "tag" */ './container/tag'),
      loading: Loading,
    });
