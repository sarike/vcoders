...
export default class TopicForm extends PureComponent {
  ...
  handleFieldChange(e) {
    ...
    this.setState((prevState) => {
      ...
      const valRet = validateField(
        nextFormData[validateFieldName],
        rules[validateFieldName],
        nextFormData,
      );
      return {
      ...
      <div className="card topic-form">
        <div className="card-body">
          ...
          <div className="form-group">
            ...
            <small className="form-text text-muted">
              主题内容支持 Markdown
              语法，作为一个靠谱的程序员，请让你发表的内容像你写的代码一样清晰。
            </small>
          </div>
          <div className="form-group">
            ...
            <small className="form-text text-muted">
              为便于更容易被别人看到，请为主题设置准确的标签，多个标签请以逗号分隔。
            </small>
          </div>
          <button
            type="button"
